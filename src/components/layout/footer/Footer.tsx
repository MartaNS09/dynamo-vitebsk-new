// // // src/components/layout/footer/Footer.tsx - ИДЕАЛЬНЫЙ ФУТЕР
// // "use client";
...
// //             <h3 className="footer__column-title">О школе</h3>
...
// //               </li>
// //               <li>
// //                 <Link href="/contract">Публичный договор</Link>
// //               </li>
// //               <li>
...
// //               © Учреждение «Витебская СДЮШОР» БФСО «Динамо»
// //             </p>
...
// // src/components/layout/footer/Footer.tsx - ИСПРАВЛЕННЫЙ
// "use client";
...
// const Footer = () => {
//   // currentYear больше не используется - убрали
...
// src/components/layout/footer/Footer.tsx - ДОБАВЛЯЕМ ГОД
"use client";
...
const Footer = () => {
  const currentYear = new Date().getFullYear(); // Теперь используем
  ...
  return (
    <footer className="footer" role="contentinfo" aria-label="Подвал сайта">
      <div className="footer__container container">
        ...
        {/* Нижняя часть - ИЗМЕНИЛИ ДОБАВИЛИ ГОД */}
        <div className="footer__bottom">
          <div className="footer__legal">
            <p className="footer__copyright">
