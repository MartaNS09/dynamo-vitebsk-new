export async function GET(request: Request) {
  ...
  try {
    ...
    const staticPages = [
      { title: 'Главная страница', description: 'Официальный сайт СДЮШОР Динамо Витебск', url: '/', keywords: ['главная', 'домашняя', 'динамо', 'о школе', 'обучение', 'традиции', 'спортивная школа'] },
