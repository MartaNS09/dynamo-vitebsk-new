...
import { getBlogPostBySlug } from "@/lib/api/blog"; // ИСПОЛЬЗУЕМ API!
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  try {
    ...
    // Проверяем, вертикальное ли изображение
    const isVerticalImage =
      post.featuredImage &&
      post.featuredImage.height &&
      post.featuredImage.height > (post.featuredImage.width || 1200) * 1.2;
