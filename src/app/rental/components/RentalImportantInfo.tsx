export function RentalImportantInfo() {
  return (
    <div
      className="rental-important-info"
      role="region"
      aria-labelledby="important-info-title"
    >
      <div className="rental-important-header">
        <div className="rental-warning-icon" aria-hidden="true">
          ⚠️
        </div>
        <h3 className="rental-important-title" id="important-info-title">
          ВАЖНАЯ ИНФОРМАЦИЯ!
        </h3>
        <p className="rental-important-subtitle">
          Пожалуйста, ознакомьтесь с условиями проката перед арендой
        </p>
      </div>
        ...
        <div className="rental-info-column">
          <div className="info-item">
            ...
            <div>
              ...
              <p className="info-text">
                Для аренды необходим{" "}
                <strong className="highlight">паспорт РБ</strong> или документ,
                его заменяющий
              </p>
            </div>
          </div>
          ...
          <div className="info-item">
            ...
            <div>
              ...
              <p className="info-text">
                Залоговая сумма устанавливается индивидуально для каждого вида
                инвентаря
              </p>
            </div>
          </div>
          ...
          <div className="info-item">
            ...
            <div>
              ...
              <p className="info-text">
                Инвентарь предоставляется в чистом и исправном состоянии
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rental-info-column">
          ...
          <div className="info-item">
            ...
            <div>
              ...
              <p className="info-text">
                Работаем за наличный и безналичный расчёт. Принимаем заявки от
                юридических лиц!
              </p>
            </div>
          </div>
      ...
      <div className="rental-tip">
        ...
        <p className="tip-text">
          <strong>Совет:</strong> Для аренды на выходные рекомендуем бронировать
          инвентарь заранее, особенно в пиковые сезоны.
        </p>
      </div>
    </div>
  );
